...
function material_blog_setup() {
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'material-blog' ),
	) );
 ...
 */
function material_blog_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'material_blog_content_width', 640 );
}
add_action( 'after_setup_theme', 'material_blog_content_width', 0 );
...
function material_blog_scripts() {
	wp_enqueue_style( 'material-blog-style', get_stylesheet_uri() );

	wp_enqueue_script( 'material-blog-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );
